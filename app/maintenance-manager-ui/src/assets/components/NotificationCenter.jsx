    ...
    return (
        <div ref={dropdownRef} className="relative">
            ...
            <button
                ...
                className="relative flex items-center gap-2 rounded-lg p-2 text-gray-600 hover:bg-gray-100 transition-all"
            ...
            {/* Dropdown */}
            {isOpen && (
                <div className="absolute right-0 z-50 mt-2 w-96 origin-top-right rounded-2xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                    {/* Header */}
